from torch_geometric.nn import GCNConv, GATConv, SAGEConv, ChebConv, GINConv, TransformerConv
...
class GINConvolution(Module):
    def __init__(self, args, num_features, hidden_units):
        super().__init__()
        self.conv1 = GINConv(Linear(num_features, hidden_units)) 
        self.conv2 = GINConv(Linear(hidden_units, args['num_classes']))
...
class GTConvolution(Module):
    def __init__(self, args, num_features, hidden_units):
        super().__init__()
        self.conv1 = TransformerConv(num_features, hidden_units)
        self.conv2 = TransformerConv(hidden_units, args['num_classes'])
