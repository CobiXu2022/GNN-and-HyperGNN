...
def parse():
	...
	p.add('--model', type=str, choices=['gcn', 'gat', 'sage', 'cheb'], default='gcn', help='model type to use (gcn, gat, sage, cheb)')
	p.add('--optimizer', type=str, choices=['adam', 'sgd', 'adadelta'], default='sgd', help='optimizer type to use (adam, sgd, adadelta)')
